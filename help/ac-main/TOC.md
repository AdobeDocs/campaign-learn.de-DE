...
+ Prozessverwaltung und Automatisierung{#process-management}
   ...
   + [InhaltsDigest erstellen](help/tutorial-using-soap-apis/create-a-content-digest-overview.md)
+ Daten-Management {#data-management}
   ...
   + [Tutorial: Verwenden von SOAP-APIs](https://experienceleague.adobe.com/docs/campaign-learn/using-soap-apis/introduction.html?lang=en)
