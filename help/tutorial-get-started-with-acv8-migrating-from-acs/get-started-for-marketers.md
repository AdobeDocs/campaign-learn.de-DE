...
* [Entdecken der Benutzeroberfläche](https://experienceleague.adobe.com/de/docs/campaign-web/v8/start/user-interface)
...
[Testprofile erstellen und verwalten](https://experienceleague.adobe.com/de/docs/campaign-web/v8/audiences/work-with-profiles/test-profiles){target="_blank"}
...
1. [Leitplanken und Einschränkungen für Workflows](https://experienceleague.adobe.com/de/docs/campaign-web/v8/wf/guardrails){target="_blank"}
