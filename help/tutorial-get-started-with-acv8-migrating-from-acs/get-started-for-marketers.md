...
[Dokumentation zur Adobe Campaign Web-Benutzeroberfläche](https://experienceleague.adobe.com/de/docs/campaign-web/v8/campaign-web-home)
...
[Erstellen und Verwalten von Testprofilen](https://experienceleague.adobe.com/de/docs/campaign-web/v8/audiences/work-with-profiles/test-profiles){target="_blank"}
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/de/docs/campaign-web/v8/msg/email/monitor/schedule-sending" target="_blank" rel="referrer" title="Planen des Sendevorgangs eines Versands">Planen des Sendevorgangs eines Versands</a>
                    </p>
                    <p class="is-size-6">Erfahren Sie, wie Sie einen Versand planen</p>
                </div>
                <a href="https://experienceleague.adobe.com/de/docs/campaign-web/v8/msg/email/monitor/schedule-sending" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Monitor delivery logs">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/de/docs/campaign-web/v8/msg/email/monitor/delivery-logs" target="_blank" rel="referrer" title="Überwachen von Versandlogs">Überwachen von Versandlogs</a>
                    </p>
                    <p class="is-size-6">Erfahren Sie, wie Sie Versandlogs überwachen</p>
                </div>
                <a href="https://experienceleague.adobe.com/de/docs/campaign-web/v8/msg/email/monitor/delivery-logs" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">Weitere Informationen</span>
                </a>
            </div>
        </div>
...
<img alt="Validierung" src="_assets/send_sms.png">
</a>
<div>
...
<img alt="Gelegentlich" src="_assets/push_design.jpeg">
</a>
<div>
...
<img alt="Validierung" src="_assets/push_send.jpeg">
</a>
<div>
...
<img alt="Validierung" src="_assets/lp-design.jpg">
</a>
<div>
...
<img alt="Validierung" src="_assets/lp-reporting.jpg">
</a>
<div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Get started with content fragments">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/de/docs/campaign-web/v8/content/manage-reusable-content/fragments/fragments" target="_blank" rel="referrer" title="Erste Schritte mit Inhaltsfragmenten">Erste Schritte mit Inhaltsfragmenten</a>
                    </p>
                    <p class="is-size-6">Erfahren Sie, wie Sie Inhaltsfragmente erstellen</p>
                </div>
                <a href="https://experienceleague.adobe.com/de/docs/campaign-web/v8/content/manage-reusable-content/fragments/fragments" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">Weitere Informationen</span>
                </a>
            </div>
        </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Add offers in your messages">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                ...
                <a href="https://experienceleague.adobe.com/de/docs/campaign-web/v8/msg/offers" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">Weitere Informationen</span>
                </a>
            </div>
        </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/de/docs/campaign-web/v8/reports/standard-reports/global-report/global-reports" title="Allgemeine Berichte" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://experienceleague.adobe.com/de/docs/campaign-web/v8/reports/standard-reports/global-report/global-reports./media_1e3aefd7c07e641a8fc0b20ca46dfbb886e5a003b.png?width=400&format=png&optimize=medium" alt="Allgemeine Berichte"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Manage assets with Adobe Experience Manager Assets as a Cloud Service">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/de/docs/campaign-web/v8/integrations/aem-assets" target="_blank" rel="referrer" title="Verwalten von Assets mit Adobe Experience Manager Assets as a Cloud Service">Verwalten von Assets mit Adobe Experience Manager Assets as a Cloud Service</a>
                    </p>
                    <p class="is-size-6">Erfahren Sie, wie Sie mit Adobe Experience Manager Assets as a Cloud Service Assets verwalten können</p>
                </div>
                <a href="https://experienceleague.adobe.com/de/docs/campaign-web/v8/integrations/aem-assets" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">Weitere Informationen</span>
                </a>
            </div>
        </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Manage assets with Adobe Experience Manager as a Cloud Service">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/de/docs/campaign-web/v8/integrations/aem-content" target="_blank" rel="referrer" title="Verwalten von Assets mit Adobe Experience Manager as a Cloud Service">Verwalten von Assets mit Adobe Experience Manager as a Cloud Service</a>
                    </p>
                    <p class="is-size-6">Erfahren Sie, wie Sie Inhalte mit Adobe Experience Manager as a Cloud Service verwalten können</p>
                </div>
                <a href="https://experienceleague.adobe.com/de/docs/campaign-web/v8/integrations/aem-content" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">Weitere Informationen</span>
                </a>
            </div>
        </div>
...
<div class="columns">
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Work with Campaign and Adobe Analytics">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/de/docs/campaign/campaign-v8/connect/ac-aa" target="_blank" rel="referrer" title="Arbeiten mit Campaign und Adobe Analytics">Arbeiten mit Campaign und Adobe Analytics</a>
                    </p>
                    <p class="is-size-6">Erfahren Sie, wie Sie Campaign und Analytics integrieren.</p>
                </div>
                <a href="https://experienceleague.adobe.com/de/docs/campaign/campaign-v8/connect/ac-aa" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">Weitere Informationen</span>
                </a>
            </div>
        </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Sharing audiences with Adobe Experience Cloud">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/de/docs/campaign-classic/using/integrating-with-adobe-experience-cloud/audience-sharing/sharing-audiences-with-adobe-experience-cloud" title="Freigabe von Zielgruppen mit Adobe Experience Cloud" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://cdn.experienceleague.adobe.com/thumb/exl-cards/documentation.png" alt="Freigabe von Zielgruppen mit Adobe Experience Cloud"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Work with Campaign and Adobe Target">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/de/docs/campaign/campaign-v8/connect/ac-at" target="_blank" rel="referrer" title="Campaign und Adobe Target verwenden">Arbeiten mit Campaign und Adobe Target</a>
                    </p>
                    <p class="is-size-6">Erfahren Sie, wie Sie Campaign und Adobe Target gemeinsam nutzen können</p>
                </div>
                <a href="https://experienceleague.adobe.com/de/docs/campaign/campaign-v8/connect/ac-at" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">Weitere Informationen</span>
                </a>
            </div>
        </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Work with Campaign and Adobe Experience Cloud triggers">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/de/docs/campaign/campaign-v8/connect/ac-triggers" title="Arbeiten mit Campaign und Adobe Experience Cloud Triggers" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://cdn.experienceleague.adobe.com/thumb/exl-cards/documentation.png" alt="Arbeiten mit Campaign und Adobe Experience Cloud Triggers"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                ...
                <a href="https://experienceleague.adobe.com/de/docs/campaign/campaign-v8/connect/ac-triggers" target="_blank" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">Weitere Informationen</span>
                </a>
            </div>
        </div>
